...
export default function EncounterForm({ note, patients, onSubmit, onCancel, isSubmitting }) {
            ...
            <div className="border rounded-lg p-4 bg-blue-50/50">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <Input type="number" step="0.1" placeholder="98.6" value={formData.vital_signs?.temperature || ""} onChange={(e) => updateVitalSign('temperature', e.target.value)} />
                </div>
                <div className="space-y-1">
