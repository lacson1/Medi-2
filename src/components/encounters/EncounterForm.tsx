...
import { SymptomField, ConditionField } from "@/components/forms/EnhancedFormFields";
...
export default function EncounterForm({ note, patients, onSubmit, onCancel, isSubmitting }: any) {
  ...
  return (
    ...
    >
      <EnhancedFormWrapper
        title={note ? "Edit Encounter" : "New Encounter"}
        description="Enhanced clinical encounter documentation with smart suggestions"
