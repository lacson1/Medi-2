...
import { Users, UserPlus, Search, Shield, Building2, Edit, Trash2, Mail, Phone, Calendar, Download, MoreVertical, UserCheck, UserX, Ban, CheckCircle, XCircle } from "lucide-react";
...
export default function TestUserManagement() {
    ...
    const updateUserMutation = useMutation({
        ...
        onSuccess: () => {
            queryClient.invalidateQueries({ queryKey: ['test_users'] });
    ...
    const handleQuickAction = (action: any, user: any) => {
        switch (action) {
            case 'activate':
                ...
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">
                            Testing admin access to staff and organization management
                        </p>
                    </div>
