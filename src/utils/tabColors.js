...
export const getTabColorScheme = (tabValue, customScheme = null) => {
...
export const getTabClasses = (tabValue, isActive = false, customScheme = null) => {
...
export const getTabIconClasses = (tabValue, customScheme = null) => {
    const scheme = getTabColorScheme(tabValue, customScheme);
...
export const TAB_CONFIGURATIONS = {
    PATIENT_PROFILE: {
        tabs: [
            { value: 'overview', label: 'Overview', icon: 'Activity', scheme: 'MEDICAL' },
            { value: 'appointments', label: 'Appointments', icon: 'Calendar', scheme: 'COMMUNICATION' },
            { value: 'prescriptions', label: 'Prescriptions', icon: 'Pill', scheme: 'PHARMACY' },
            { value: 'labs', label: 'Labs', icon: 'Beaker', scheme: 'LABORATORY' },
            { value: 'consents', label: 'Consents', icon: 'FileSignature', scheme: 'PATIENT' },
            { value: 'billing', label: 'Billing', icon: 'DollarSign', scheme: 'FINANCIAL' },
            { value: 'documents', label: 'Documents', icon: 'FileText', scheme: 'ADMIN' },
            { value: 'timeline', label: 'Timeline', icon: 'Activity', scheme: 'PATIENT' }
        ]
    },

    PRESCRIPTION_MANAGEMENT: {
        tabs: [
            { value: 'dashboard', label: 'Dashboard', icon: 'BarChart3', scheme: 'ANALYTICS' },
            { value: 'monitoring', label: 'Monitoring', icon: 'Activity', scheme: 'EMERGENCY' },
            { value: 'refills', label: 'Refills', icon: 'RefreshCw', scheme: 'PHARMACY' },
            { value: 'notifications', label: 'Alerts', icon: 'AlertTriangle', scheme: 'EMERGENCY' },
            { value: 'history', label: 'History', icon: 'FileText', scheme: 'ANALYTICS' },
            { value: 'analytics', label: 'Analytics', icon: 'BarChart3', scheme: 'ANALYTICS' },
            { value: 'database', label: 'Database', icon: 'Database', scheme: 'ADMIN' },
            { value: 'settings', label: 'Settings', icon: 'Settings', scheme: 'SETTINGS' }
        ]
    },

    BILLING: {
        tabs: [
            { value: 'invoices', label: 'Invoices', icon: 'FileText', scheme: 'FINANCIAL' },
            { value: 'payments', label: 'Payments', icon: 'CreditCard', scheme: 'FINANCIAL' },
            { value: 'analytics', label: 'Analytics', icon: 'BarChart3', scheme: 'ANALYTICS' }
        ]
    },
    ...
    LAB_MANAGEMENT: {
        tabs: [
            { value: 'orders', label: 'Orders', icon: 'ClipboardList', scheme: 'LABORATORY' },
            { value: 'results', label: 'Results', icon: 'FileText', scheme: 'LABORATORY' },
            { value: 'quality', label: 'Quality Control', icon: 'Shield', scheme: 'LABORATORY' },
            { value: 'reports', label: 'Reports', icon: 'BarChart3', scheme: 'ANALYTICS' }
        ]
    }
};