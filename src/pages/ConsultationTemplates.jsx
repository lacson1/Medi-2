...
export default function ConsultationTemplates() {
  ...
  const createTemplateMutation = useMutation({
    mutationFn: (data) => base44.entities.ConsultationTemplate.create(data),
    onSuccess: () => {
  ...
  const updateTemplateMutation = useMutation({
    mutationFn: ({ id, data }) => base44.entities.ConsultationTemplate.update(id, data),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['consultation_templates'] });
      setModalContent(null);
    },
  ...
  const deleteTemplateMutation = useMutation({
    mutationFn: (id) => base44.entities.ConsultationTemplate.delete(id),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['consultation_templates'] });
  ...
  const handleSubmit = (templateData, editingTemplate) => {
    if (editingTemplate) {
